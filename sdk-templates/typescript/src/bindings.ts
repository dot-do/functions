/**
 * capnweb RPC Bindings for my-function
 *
...
/**
 * RPC Client for invoking methods on a remote my-function instance.
 *
 ...
 * const client = new my-functionClient(env.MY_FUNCTION)
 * const greeting = await client.greet('World')
 * console.log(greeting.message) // "Hello, World!"
 *
 * // Using direct fetch
 * const client = new my-functionClient('https://my-function.workers.dev')
