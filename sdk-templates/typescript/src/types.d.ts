/**
 * Auto-generated type definitions for {{functionName}}
 *
 ...
 */
export interface {{FunctionName}}TargetFunctions {
 ...
 */
export interface {{FunctionName}}TargetMethods extends {{FunctionName}}TargetFunctions {
  /**
 ...
 */
export declare class {{FunctionName}}Target extends RpcTarget implements {{FunctionName}}TargetMethods {
  constructor(env: Env, functions: {{FunctionName}}TargetFunctions)
...
export type MyFunctionTargetMethods = {{FunctionName}}TargetMethods
export declare class MyFunctionTarget extends {{FunctionName}}Target {}
